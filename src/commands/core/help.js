...
module.exports.run = async (cmd, client, args, message) => {
    ...
    */
    ...
    let embed = new RichEmbed()
        ...
        .addField(":moneybag: Economy", "`" + prefix + "coins`, `" + prefix + "givecoins`, `" + prefix + "leaderboard`, `" + prefix + "daily`, `" + prefix + "weekly`, `" + prefix + "monthly`")
        .addField(":tada: Fun", "`" + prefix + "anime`, `" + prefix + "wynncraft`, `" + prefix + "osu`, `" + prefix + "truckersmp`")
